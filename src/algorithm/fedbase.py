...
class BasicServer:
    ...
    def sample(self):
        ...
        # sample clients
            ...
            # MD sampling without replacement to avoid duplicated client ids in one round.
            num_pick = min(self.clients_per_round, len(all_clients))
            selected_clients = list(np.random.choice(all_clients, num_pick, replace=False, p=p))
    ...
    def aggregate(self, models: list, *args, **kwargs):
        ...
        ==========================================================================================================================
        N/K * 危(pk * model_k)           |1/K * 危model_k             |(1-危pk) * w_old + 危(pk * model_k)  |危(pk/危pk) * model_k
        """
